...
public class RTSPClient extends Thread implements IEvent {
	...
	public static void main(String[] args) {
		try {
			RTSPClient client = new RTSPClient(new InetSocketAddress(
					"192.168.8.122", 554), new InetSocketAddress(
					"192.168.8.122", 0), "rtsp://192.168.8.122:554/sample_h264_1mbit.mp4");
			client.start();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void doTeardown() {
		...
		sb.append("\r\n");
		sb
				.append("User-Agent: RealMedia Player HelixDNAClient/10.0.0.11279 (win32)\r\n");
		sb.append("Session: ");
		sb.append(sessionid);
		sb.append("\r\n");
	...
	private void doSetup() {
		...
		sb.append("\r\n");
		sb
				.append("Transport: RTP/AVP;UNICAST;client_port=16264-16265;mode=play\r\n");
		sb.append("\r\n");
		System.out.println(sb.toString());
		send(sb.toString().getBytes());
	}
